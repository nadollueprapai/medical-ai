  ...
  try {
    ...
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are talking to a patient who hasn't had time to see a doctor yet, 
          ...
          e.g. Rheumatologist, Cardiologist, Neurologist, Dermatologist, etc.
...
- Send the responses in a one-line, preferrably one-sentence format.`,
        },
        {
          role: "user",
          content: message,
